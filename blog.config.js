...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Youkk425', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个什么都想不干的人、一个很好很好的人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'blog,频道', // 网站关键词 英文逗号隔开
  ...
  // 自定义外部脚本，外部样式
  CUSTOM_EXTERNAL_JS: ['https://pixiv.mokeyjay.com/?r=api/pixiv-json'], // e.g. ['http://xx.com/script.js','http://xx.com/script.js']
  ...
  GREETING_WORDS:
    ...
    'Hi，一个程序员, Hi，一个打工人,Hi，一个干饭人,欢迎来到winterkingdom🎉',
